...
?>
<div id="chat_online">
<!-- mibew button --><a href="/chat/client.php?locale=pt-br" title="Converse agora com um de nossos atendentes" target="_blank" onclick="if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 &amp;&amp; window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open(&#039;/chat/client.php?locale=pt-br&amp;url=&#039;+escape(document.location.href)+&#039;&amp;referrer=&#039;+escape(document.referrer), 'mibew', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=480,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;"><img src="/chat/b.php?i=simple&amp;amp;lang=pt-br" border="0" width="130" height="135" alt=""/></a><!-- / mibew button -->
</div>
...
<div id="fundo_rodape">
                   ...
                   <a href="file:///C|/Users/JONATA/AppData/Local/Temp/fz3temp-1/devolucao-trocas.php" title="Política de trocas e devoluções da THE Brindes">
                   <p style="color:#333; float:left; margin-left:10px; font-size:14px;">Política de trocas e devoluções</p>
                    ...
                    <br />
                    <a href="http://www.internetsegura.org/" style="margin:5px;"><div style="background-image:url(file:///C|/Users/JONATA/AppData/Local/Temp/fz3temp-1/imagens/imgFooter.png); width:57px; height:22px; margin: 0 auto 0 auto;"></div></a>
                    <center>
                   <ul>
...
<a href="http://www.verisign.com/products-services/security-services/ssl/ssl-information-center/" target="_blank"  style="color:#000000; text-decoration:none; font:bold 7px verdana,sans-serif; letter-spacing:.5px; text-align:center; margin:0px; padding:0px;">Sobre certificados SSL</a></td>
                   ...
                   <!-- <a href="https://twitter.com/TheBrindes" class="twitter-follow-button" data-show-count="false" data-lang="pt">Seguir @TheBrindes</a>
...
<!-- <div class="g-plusone" data-annotation="inline" data-width="200" data-href="www.thebrindes.com.br"></div> -->
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
						...
						<div class="fb-like-box" data-href="https://www.facebook.com/thebrindes" data-width="200" data-height="250" data-show-faces="true" data-stream="false" data-show-border="false" data-header="false"></div> -->
                        <br />
<div id="fb-root"></div>
<script>(function(d, s, id) {
  var js, fjs = d.getElementsByTagName(s)[0];
...
<div class="fb-like" data-href="http://www.facebook.com/thebrindes" data-width="290" data-show-faces="false" data-send="true"></div>
