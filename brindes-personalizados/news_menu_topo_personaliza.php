	...
	<div class="topo">
    	<div class="conteudo_topo">
			...
			<?php if(!isset($_SESSION['email_the'])){ ?>            
        		<li><a href="../loginCompra.php"class="ico_top" title="Entre na sua conta THE Brindes"><div class="img_conta"></div><span>Entrar</span></a></li>
        		<li><a href="../cadastro_usuario.php" class="ico_top" title="Crie uma conta na THE Brindes"><div class="img_add"></div><span>Cadastre-se</span></a></li>
        	<?php } ?> 
            <!-- si o usuario estiver cadastrado  aparece o nome dele no topo-->
            <?php if(isset($_SESSION['email_the'])){ ?>
           		
                <li><a href="?ac=sair" class="ico_top"><span>Sair</span></a><a href="../dashboard.php" class="ico_top"><div class="img_add"></div><span>Minha Conta</span></a><a class="ico_top">Olá, <?php echo $_SESSION['nome_usuario'] ?></a></li>
        	<?php } ?>                       		
    		</ul>
			</nav>
</div>
            <div id="<?php if($browser == 'IE') echo 'centro_topIE'; else echo 'centro_top' ?>">
                    <!--MUDAR LINK PARA IR PARA INDEX-->          
               		<div class="<?php if($browser == 'IE') echo 'logoie'; else echo 'logo'; ?>"><a href="<?php get_home(); ?>"><img src="../imagens/logo3.png" width="305" height="50" alt="Logo Teresina Brindes" title="Logo Teresina Brindes: Comunicação Visual" border="0" /></a></div>
...
<p class="carrinho">
					<a href="../checkout.php" title="Visualize seu carrinho">
...
<li class="menu_right3"><div class="img_personalize"></div><a href="../personalize-online.php" class="drop3" title="Personalize direto do site!">PERSONALIZE</a></li>
</ul>
