            ...
            <div id="conteudo_produtos">         
              <div class="tabela_produtos">
                ...
                <div style="width:727px">
                	...
                	<a href="produtos_brindes.php?id=<?php echo $row_categorias['cat_id']; ?>" title="Veja todos os produtos da categoria: <?php echo $row_categorias['cat_nome']; ?>">veja todos</a></p>
               <br class="cancela">
               <hr />
                </div>
...
//numero de colunas dos produtos
				...
				echo "
				<a title='$nome_produto personalizado(a)' href='brindes-personalizados/index.php?cat=".$row_new_produtos_index['subcat_cat_id']."&subcatid=" . $row_new_produtos_index['subcat_id'] . "'>
						...
						<p align='center'><span class='novo-botao-verde1'>Personalize agora!</span></p>
							...
							";
								...
								$nome_produto2 = $row_new_produtos_index['subcat_nome']; // para poder botar no tittle da imagem
								 echo "
								<a title='$nome_produto2 personalizado(a)' href='brindes-personalizados/orcamento.php?cat=".$row_new_produtos_index['subcat_cat_id']."&subcatid=" . $row_new_produtos_index['subcat_id'] . "'>
								<div itemscope itemtype='http://schema.org/Product' id='exibe_produtos'>
									<div id='foto_vitrine'>
