...
<a href="<?php// get_home() ?>/chat/client.php?locale=pt-br" target="_blank" onclick="if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 &amp;&amp; window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open(&#039;<?php/ get_home() ?>/chat/client.php?locale=pt-br&amp;url=&#039;+escape(document.location.href)+&#039;&amp;referrer=&#039;+escape(document.referrer), 'mibew', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=480,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;"><img src="<?php/ get_home() ?>/chat/b.php?i=simple&amp;amp;lang=pt-br" border="0" width="130" height="135" alt=""/></a>
</div>
-->
<div id="fundo_rodape">
                   ...
                   <a href="<?php get_home() ?>/devolucao-trocas.php" title="Política de trocas e devoluções da THE Brindes">
                   <p style="color:#333; float:left; margin-left:10px; font-size:14px;">Política de trocas e devoluções</p>
                    ...
                    <br />
                    <a href="http://www.internetsegura.org/" style="margin:5px;"><div style="background-image:url(<?php get_home() ?>/imagens/imgFooter.png); width:57px; height:22px; margin: 0 auto 0 auto;"></div></a>
                    <center>
                   <ul>
...
<a href="http://www.verisign.com/products-services/security-services/ssl/ssl-information-center/" target="_blank"  style="color:#000000; text-decoration:none; font:bold 7px verdana,sans-serif; letter-spacing:.5px; text-align:center; margin:0px; padding:0px;">Sobre certificados SSL</a></td>
                    ...
                    <div>
                       ...
                       <a href="<?php get_home() ?>/seguranca-privacidade.php" title="Privacidade e segurança da THE Brindes"><p style="color:#333; float:left; margin-left:10px; font-size:14px;">Privacidade e Segurança</p></a>
                    </div>
                   </ul>
                   </center>
