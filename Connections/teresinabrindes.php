...
/*
$conexao = mysql_connect('localhost','teres387', '209Dwy3bYx') or die (mysql_error());
...
mysql_select_db('teres387_teresinabrindes') or die ('Error ao conectar com o banco de dados, por favor entrar em contato com a Invista.');
